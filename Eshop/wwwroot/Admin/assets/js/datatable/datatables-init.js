    ...
    return {
        init: function () {
            ...
            function fnFormatDetails(oTable, nTr) {
                var aData = oTable.fnGetData(nTr);
                var sOut = '<table>';
                sOut += '<tr><td rowspan="5" style="padding:0 10px 0 0;"><img style="10px 20px 20px 20px" src="/images/thumb/' + aData[6] + '"/></td></tr>';
                sOut += '<tr><td>نام محصول :</td><td>' + aData[1] + '</td></tr>';
                sOut += '<tr><td>قیمت:</td><td>' + aData[2] + '</td></tr>';
                sOut += '<tr><td>تعداد:</td><td>' + aData[3] + '</td></tr>';
                sOut += '<tr><td>توضیح کوتاه محصول:' + aData[4] + '</td></tr>';
                sOut += '</table>';
                return sOut;
            }
